...
<body>
    ...
    include('sidebar.php')?>
        ...
        <section class="middle">
            <div class="header">
                <h1><span class="material-symbols-sharp">supervisor_account</span>Ticketing - Tickets en cours</h1>
            </div>
            <!-- LIST ADMIN -->
    ...
    $stmt = $sql->prepare("SELECT * FROM ticketing WHERE status = 'in_progress' ORDER BY `id` DESC");
    $stmt->execute();
